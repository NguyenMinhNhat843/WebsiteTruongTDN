    ...
    return (
      <div className="w-full shadow-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100 overflow-hidden">
          ...
          {/* ── Editor area ── */}
          <div
            className="relative [&_.ProseMirror]:focus-visible:outline-none [&_.ProseMirror_img]:cursor-pointer 
        [&_.ProseMirror_img]:rounded-lg [&_.ProseMirror_img]:transition-all 
        [&_.ProseMirror_img.ProseMirror-selectednode]:ring-2 
        [&_.ProseMirror_img.ProseMirror-selectednode]:ring-indigo-500 
        [&_.ProseMirror_img.ProseMirror-selectednode]:ring-offset-2 
        [&_.ProseMirror_img.ProseMirror-selectednode]:shadow-lg 
        [&_.ProseMirror_img]:max-w-full [&_.ProseMirror_h1]:text-3xl 
        [&_.ProseMirror_h1]:font-extrabold [&_.ProseMirror_h1]:text-slate-800 
        [&_.ProseMirror_h1]:mt-6 [&_.ProseMirror_h1]:mb-3 [&_.ProseMirror_h2]:text-2xl 
        [&_.ProseMirror_h2]:font-bold [&_.ProseMirror_h2]:text-slate-800 
        [&_.ProseMirror_h2]:mt-5 [&_.ProseMirror_h2]:mb-2 [&_.ProseMirror_h3]:text-xl 
        [&_.ProseMirror_h3]:font-semibold [&_.ProseMirror_h3]:text-slate-700 
        [&_.ProseMirror_h4]:text-lg [&_.ProseMirror_h4]:font-semibold 
        [&_.ProseMirror_h4]:text-slate-700 [&_.ProseMirror_p]:text-slate-700 
        [&_.ProseMirror_p]:leading-relaxed [&_.ProseMirror_p]:my-2"
          >
          ...
          <div className="border-t border-slate-100 px-5 py-2.5 flex items-center justify-between bg-slate-50/50">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-medium text-slate-500">
                <span
                  className={
                    charCount > 0 ? "text-indigo-600 font-semibold" : ""
                  }
                >
