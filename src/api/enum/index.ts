...
export const CAMPAIGN_STATUS_MAP: Record<NonNullable<CampaignStatusEnum>, { label: string; colorClass: string }> = {
...
export const APPLICATION_STATUS_MAP: Record<NonNullable<ApplicationStatusEnum>, { label: string; colorClass: string }> = {
...
export const DOCUMENT_STATUS_MAP: Record<NonNullable<DocumentStatusEnum>, { label: string; colorClass: string }> = {
