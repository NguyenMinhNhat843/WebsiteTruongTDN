...
import { Plus, Edit2, Trash2, Calendar, FileCheck, X, Loader2, ListPlus, ClipboardList } from 'lucide-react'
...
const DocumentConfigManagement = () => {
  ...
  return (
    <PageShell
      title="Cấu Hình Hồ Sơ Tuyển Sinh"
      sub="Quản lý các loại hồ sơ, giấy tờ cần thiết cho quá trình đăng ký xét tuyển"
      icon={ClipboardList}
      renderRight={
        <ButtonAction
