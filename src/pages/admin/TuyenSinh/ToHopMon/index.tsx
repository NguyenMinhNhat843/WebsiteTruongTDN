...
const ToHopMonHome: React.FC = () => {
  ...
  return (
    <PageShell
      title="Quản Lý Tổ Hợp Môn Xét Tuyển"
      sub="Quản lý các khối thi & tổ hợp môn xét tuyển (Ví dụ: A00, A01, D01...)"
      icon={BookOpen}
      renderRight={
        <ButtonAction label="Thêm tổ hợp môn" onClick={openCreateModal} icon={<Plus className="h-4 w-4" />} />
      }
    >
