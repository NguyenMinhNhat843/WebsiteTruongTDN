...
import { BookOpen, Layers, Code, Type, Hash, Clock, X } from "lucide-react";
...
const UpdateMonHoc = ({ idSelected, onClose }: UpdateMonHocModalProps) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      theoryHours: 0,
      practiceHours: 0,
      testHours: 0, // Thêm trường testHours vào defaultValues
    },
  });
  ...
  // Hàm loại bỏ dấu tiếng Việt để sinh mã không bị dính ký tự có dấu
  ...
  useEffect(() => {
    if (monHocDetail) {
      reset({
        ...
        testHours: monHocDetail.testHours || 0, // Đổ dữ liệu trường testHours
        departmentId: monHocDetail.departmentId || null, // Đổ dữ liệu trường bộ môn
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-3xl overflow-hidden border border-slate-100 flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-150">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            {/* Hàng 2: Cấu hình Tín chỉ / Số giờ */}
            ...
            {/* Hàng 3: Chọn Khoa/Bộ môn (Department) */}
