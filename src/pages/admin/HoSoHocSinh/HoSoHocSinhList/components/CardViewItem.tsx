...
import type { HocSinhDto } from "../../../../../features/HocSinh/HocSinhProvider";
    ...
    <div className="bg-white border border-slate-100 rounded-2xl shadow-sm hover:shadow-md hover:border-blue-100 transition-all overflow-hidden group">
      <div className="p-4">
        <div className="flex items-start gap-3">
          <div
            className={`w-11 h-11 rounded-xl bg-linear-to-br ${avatarColor(String(row.id))} flex items-center justify-center text-white font-black text-[16px] shrink-0`}
          >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-1.5 flex flex-wrap gap-1">
              <TrangThaiBadge value={row.status} />
            </div>
          </div>
        </div>
